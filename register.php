      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            <h1 class="mb-4" data-scrollax="properties: { translateY: '30%', opacity: 1.5}"><strong>Explore <br></strong> your favourate event</h1>
...
<section class="ftco-section contact-section ftco-degree-bg">
        ...
        <div class="row block-9">
          <div class="col-md-6 pr-md-5">
            <form id="signup_form" onsubmit="return false" class="was-validated">
              ...
              <div class="form-group">
                <input type="text" class="form-control field-border" name="upi" placeholder="upi reference number(12 digit)" required>
              </div>
               <div class="form-group">
  ...
  <div class="card-body">
    <p class="card-text">Scan the qr and pay the respective amount of your event .</p>
  </div>
</div>
